...
// -----------------------------------------------------------
export function calcSkillAttackDamage(skillId: string, level: number): number {
...
// -----------------------------------------------------------
export function calcClawDamage(level: number): number {
...
// -----------------------------------------------------------
export function calcFireBreathDamage(level: number): number {
