...
// DOM-Aufbau
// ────────────────────────────────────────────────────────────
function buildElements(container: HTMLElement): {
  zone: HTMLElement;
  thumb: HTMLElement;
} {
 ...
 */
export function createJoystick(container: HTMLElement): JoystickState {
  injectStyles();
