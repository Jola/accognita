...
// -----------------------------------------------------------
export function calcChitinDr(level) {
...
// -----------------------------------------------------------
export function calcVenomChance(level) {
...
// -----------------------------------------------------------
export function calcVenomDmgPerTick(level) {
...
export function calcJumpDistance(level) {
...
// -----------------------------------------------------------
export function calcHemolymphReflect(level) {
    return 2 * level;
}
// -----------------------------------------------------------
...
// -----------------------------------------------------------
export function calcSuperstrengthMult(level) {
...
// -----------------------------------------------------------
export function calcPhotosynthesisHeal(level) {
    return 0.5 * level;
}
//# sourceMappingURL=SkillEffects.js.map