...
export declare function tickRangedCooldown(instance: EntityInstance, deltaMs: number): void;
export declare function setRangedCooldown(instance: EntityInstance, def: EntityDefinition): void;
